...
INSERT INTO jobs (customer_id, title, description, pickup_address, delivery_address, pickup_latitude, pickup_longitude, delivery_latitude, delivery_longitude, pickup_date, delivery_date, weight_kg, pallet_count, estimated_price, status) VALUES
  (1, 'Furniture Delivery - Sydney to Melbourne', 'Urgent delivery of office furniture. Requires careful handling and delivery to 3rd floor office. No elevator available.', '123 George St, Sydney, NSW 2000', '456 Collins St, Melbourne, VIC 3000', -33.8688, 151.2093, -37.8136, 144.9631, NOW() + INTERVAL '1 day', NOW() + INTERVAL '3 days', 1500.00, 4, 2500.00, 'open'),
  (1, 'Electronics Shipment', 'Fragile electronics requiring temperature controlled transport. High value items.', '789 Pitt St, Sydney, NSW 2000', '321 Bourke St, Melbourne, VIC 3000', -33.8679, 151.2073, -37.8140, 144.9633, NOW() + INTERVAL '2 days', NOW() + INTERVAL '4 days', 800.00, 2, 1800.00, 'open'),
  (2, 'Construction Materials', 'Steel beams and construction materials for building site. Crane required for unloading.', '555 Industry Rd, Sydney, NSW 2015', '777 Construction Ave, Brisbane, QLD 4000', -33.8548, 151.1957, -27.4698, 153.0251, NOW() + INTERVAL '5 days', NOW() + INTERVAL '7 days', 8000.00, 0, 4500.00, 'open');

-- Insert sample bids
INSERT INTO bids (job_id, carrier_id, price, message, status) VALUES
